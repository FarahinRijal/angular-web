  ...
  $con = mysqli_connect('localhost','u570110870_geopusara20','Geopusara@20','u570110870_geopusara');
	...
	else
	{
		...
		{	
			...
			$insertuserquerry = "INSERT INTO accounts(`id`, `fullname`, `username`, `email`, `type`, `password`, `phone`, `job`, `message`, `date`, `status`) VALUES ( NULL, '".$insertfullname."','".$insertusername."','".$insertemail."','".$type."','".$insertpassword."','".$insertphone."','".$insertjob."','".$message."',CURRENT_TIMESTAMP,'".$status."')";
