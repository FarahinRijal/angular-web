...
@Component({
  selector: 'app-popupmap',
  templateUrl:'./popupmap.component.html',
  styleUrls: ['./popupmap.component.scss'],
})
export class PopupmapComponent implements OnInit {
  ...
  saveLocation(){
    ...
    this.router.navigate(['/userdaftarkubur'], {queryParams: {data1 : addr, data2 : lat, data3 : lng}});
